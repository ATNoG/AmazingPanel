...
EdEditor.prototype.templates = {
  ...
  groups: $.template("tmpl_groups", "<div class=\"grid-view-row\"><div class=\"sidetable-group-select group-color\" style=\"background-color: ${color}\"><input value=\"${name}\" type=\"hidden\"/></div><div>${nodes}</div></div>"),
  apps: $.template("tmpl_apps", "<div class=\"grid-view-row\"><div class=\"sidetable-app-select group-color\" style=\"background-color: ${color}\"><input value=\"${group}\" type=\"hidden\"/></div><div>${app}</div></div>")
